<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="books.aspx.cs" Inherits="Library_Management_System.books" %>
    ...
    <section>
      <h1
        style="
          ...
          font-weight: bolder;
          display: block;
          background-color: rgb(38, 138, 138);
          color: white;
          padding: 5px;
          margin: 10px;
        "
      ...
      <a
        ...
        "
        id="viewbooksindex"
        >You need to be logged in to see all books></a
      >
    </section>
    <footer>
